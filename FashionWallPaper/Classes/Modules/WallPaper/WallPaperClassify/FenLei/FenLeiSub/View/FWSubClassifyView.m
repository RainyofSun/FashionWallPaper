...
static NSString *SubClassifyCell = @"WallPaperCell";

@interface FWSubClassifyView ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>

/** collectionView */
@property (nonatomic,strong) UICollectionView *collectionView;
/** dataSource */
@property (nonatomic,strong) NSArray <FWSubClassifyPicModel *>*dataSource;

@end

@implementation FWSubClassifyView
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    FWWallPaperCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:SubClassifyCell forIndexPath:indexPath];
...
- (void)setupUI {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"FWWallPaperCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:SubClassifyCell];
